...
LUA_SHA1 = get_hash(os.path.join(CWD, 'jamiiforums.lua'))
...
project = Project(
    title = 'jamiiforums',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://archiveteam.org/images/b/b9/JamiiForums_logo.png" height="50px"/>
    <h2>jamiiforums.com <span class="links"><a href="https://www.jamiiforums.com/">Website</a> &middot; <a href="https://tracker.archiveteam.org/jamiiforums/">Leaderboard</a></span></h2>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://%s/%s' % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix='jamiiforums'),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
